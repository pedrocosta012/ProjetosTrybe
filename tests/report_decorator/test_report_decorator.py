...
def test_decorar_relatorio():
    ...
    result_complete_report = result_simple_report + (
    ...
    assert colored_simple_report.generate(products) == result_simple_report
    assert colored_complete_report.generate(products) == result_complete_report
