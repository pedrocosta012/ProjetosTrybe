...
const mult = (num1, num2) => ({ mult: num1 * num2 });
const div = (num1, num2) => ({ div: Math.floor(num1 / num2) });
const sub = (num1, num2) => ({ sub: num1 - num2 });

const calculator = (number1, number2) => {
  const operations = Object.assign(sum(number1, number2), 
