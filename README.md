...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-022-b-project-delivery-app.git`.
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-022-b-project-delivery-app/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-022-b-project-delivery-app/pulls) e confira que o seu _Pull Request_ está criado
...
<details>
  ...
  ➡️ Este projeto já vem com as dependências relacionadas ao _linter_ configuradas nos arquivos `package.json` nos seguintes caminhos:
    - `sd-022-b-project-delivery-app/back-end/package.json`
    - `sd-022-b-project-delivery-app/front-end/package.json`
...
Um bom exercício aqui é utilizar seu aprendizado de [`Railway`](https://app.betrybe.com/learn/course/5e938f69-6e32-43b3-9685-c936530fd326/module/94d0e996-1827-4fbc-bc24-c99fb592925b/section/fd648646-af98-4560-b782-bb8c1a9817ff/day/d1143e25-459a-49d9-b1a1-dd8a6632485c/lesson/c2cdb694-6913-484d-8ec1-4cfe39f2f0ee) para subir as aplicações backend, frontend e o banco de dados, garantindo a comunicação entre elas.
